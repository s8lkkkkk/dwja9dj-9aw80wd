...
RunService.RenderStepped:Connect(function()
    if Library.Toggles.Hitbox_Enabled.Value then
        for _, p in pairs(Players:GetPlayers()) do
            if p ~= LocalPlayer and p.Character and p.Character:FindFirstChild("HumanoidRootPart") then
                p.Character.HumanoidRootPart.Size = Vector3.new(Library.Options.Hitbox_Size.Value, Library.Options.Hitbox_Size.Value, Library.Options.Hitbox_Size.Value)
