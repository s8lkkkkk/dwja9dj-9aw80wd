-- Cleanup existing instance to prevent duplicates
...
-- Override toggle to sync button visibility
...
ConfigTab:AddLeftGroupbox("Management"):AddButton({Text="Minimize", Func=function() Window:Toggle() end})
