...
-- Combat Tab Content (Hitboxes + Cam Lock)
local HitboxGroup = CombatTab:AddLeftGroupbox("Hitboxes")
...
local function AddLogo(url) local i = Instance.new("ImageLabel", IconGroup.Groupbox); i.Size = UDim2.new(0, 100, 0, 100); i.Image = url; i.BackgroundTransparency = 1; i.Parent = IconGroup.Groupbox end
...
Manage:AddButton({Text="Save Settings", Func=SaveConfig})
Manage:AddButton({Text="Load Settings", Func=LoadConfig})
