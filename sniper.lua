...
local SocialGroup = ESPTab:AddLeftGroupbox("Socials")
local LogoGroup = ESPTab:AddRightGroupbox("Logos")
...
local function AddLogo(url) local i = Instance.new("ImageLabel", LogoGroup.Groupbox); i.Size = UDim2.new(0, 100, 0, 100); i.Image = url; i.BackgroundTransparency = 1; i.Parent = LogoGroup.Groupbox end
...
local ConfigGroup = CombatTab:AddLeftGroupbox("Management")
...
ConfigGroup:AddButton({Text="Save Settings", Func=SaveConfig})
ConfigGroup:AddButton({Text="Load Settings", Func=LoadConfig})
